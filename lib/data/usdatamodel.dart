...
//
//     final usmodel = usmodelFromJson(jsonString);

import 'dart:convert';

Usmodel usmodelFromJson(String str) => Usmodel.fromJson(json.decode(str));

String usmodelToJson(Usmodel data) => json.encode(data.toJson());
...
class Usmodel {
    ...
    factory Usmodel.fromJson(Map<String, dynamic> json) => Usmodel(
